//
//  WorkspaceMacComposerCardView.swift
//  OpenSpace
//
...
// MARK: - WorkspaceMacComposerCard

struct WorkspaceMacComposerCard: View {
    // MARK: Internal
    ...
    @Binding var activeProviderPopup: WorkspaceMacProviderPopup?
    ...
    private var composerControls: some View {
        if context.composerUsesCompactFallback {
            VStack(alignment: .leading, spacing: 12) {
                HStack(spacing: 10) {
                    WorkspaceMacSurfaceChip(title: "Attach", systemImage: "paperclip", colorScheme: colorScheme, context: context)
                    providerMenu
                }
