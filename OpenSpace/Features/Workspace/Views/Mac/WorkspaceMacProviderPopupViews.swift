//
//  WorkspaceMacProviderPopupViews.swift
//  OpenSpace
//
//  macOS-focused provider picker and connection popup views.
//

import SwiftUI

// MARK: - WorkspaceMacProviderPickerPopup

struct WorkspaceMacProviderPickerPopup: View {
    // MARK: Internal
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            WorkspaceMacProviderPickerHeader(dismiss: dismiss)
                .padding(.bottom, headerBottomPadding)

            WorkspaceMacProviderSearchField(searchText: $searchText)
        ...
        .background(
            RoundedRectangle(cornerRadius: 18, style: .continuous)
                .fill(WorkspaceMacProviderPickerPalette.background)
        )
        .overlay(
            RoundedRectangle(cornerRadius: 18, style: .continuous)
                .stroke(WorkspaceMacProviderPickerPalette.stroke, lineWidth: 1)
        )
        .compositingGroup()
        ...
        ScrollView(.vertical, showsIndicators: true) {
            LazyVStack(alignment: .leading, spacing: rowSpacing) {
                if filteredProviders.isEmpty {
                    WorkspaceMacProviderEmptyState(searchText: searchText)
                        .frame(maxWidth: .infinity, minHeight: emptyStateMinHeight)
                } else {
                    ForEach(filteredProviders) { provider in
                        WorkspaceMacProviderPickerRow(
                            provider: provider,
...
// MARK: - WorkspaceMacProviderPickerHeader

struct WorkspaceMacProviderPickerHeader: View {
    let dismiss: () -> Void
    ...
    var body: some View {
        HStack(alignment: .center) {
            Text("Connect provider")
                ...
                .foregroundStyle(WorkspaceMacProviderPickerPalette.primaryText)
            ...
            Button(action: dismiss) {
                Image(systemName: "xmark")
                    ...
                    .foregroundStyle(WorkspaceMacProviderPickerPalette.icon)
...
// MARK: - WorkspaceMacProviderSearchField

struct WorkspaceMacProviderSearchField: View {
    ...
    var body: some View {
        HStack(spacing: fieldSpacing) {
            ...
            TextField("Search providers", text: $searchText)
                ...
                .foregroundStyle(WorkspaceMacProviderPickerPalette.primaryText)
                .tint(WorkspaceMacProviderPickerPalette.secondaryText)
        ...
        .background(
            RoundedRectangle(cornerRadius: 12, style: .continuous)
                .fill(WorkspaceMacProviderPickerPalette.fieldBackground)
        )
        .overlay(
            RoundedRectangle(cornerRadius: 12, style: .continuous)
                .stroke(WorkspaceMacProviderPickerPalette.stroke.opacity(0.74), lineWidth: 1)
        )
...
// MARK: - WorkspaceMacProviderPickerRow

struct WorkspaceMacProviderPickerRow: View {
    ...
    var body: some View {
        Button(action: select) {
            HStack(alignment: .center, spacing: rowSpacing) {
                WorkspaceMacProviderIcon(provider: provider)
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    Text(providerSummary)
                        ...
                        .foregroundStyle(WorkspaceMacProviderPickerPalette.secondaryText)
                        .lineLimit(1)
                }
                ...
                if isSelected {
                    Image(systemName: "checkmark")
                        ...
                        .foregroundStyle(WorkspaceMacProviderPickerPalette.badgeText)
                        .frame(width: 28, height: 28)
                        .background(
                            Circle()
                                .fill(WorkspaceMacProviderPickerPalette.selectedIndicatorBackground)
                        )
                        .accessibilityHidden(true)
                }
            }
    ...
    private var rowBackground: some View {
        RoundedRectangle(cornerRadius: 12, style: .continuous)
            .fill(
                isSelected
                    ? WorkspaceMacProviderPickerPalette.selectedBackground
                    : Color.clear
            )
    }
    ...
    private var rowStroke: some View {
        RoundedRectangle(cornerRadius: 12, style: .continuous)
            .stroke(
                isSelected
                    ? WorkspaceMacProviderPickerPalette.selectedStroke
                    : Color.clear,
                lineWidth: 1
            )
    }
...
// MARK: - WorkspaceMacProviderIcon

struct WorkspaceMacProviderIcon: View {
    let provider: AIProvider

    var body: some View {
        ZStack {
            RoundedRectangle(cornerRadius: 9, style: .continuous)
                .fill(WorkspaceMacProviderPickerPalette.iconBackground)
                .overlay(
                    RoundedRectangle(cornerRadius: 9, style: .continuous)
                        .stroke(WorkspaceMacProviderPickerPalette.stroke, lineWidth: 1)
                )
...
// MARK: - WorkspaceMacProviderEmptyState

struct WorkspaceMacProviderEmptyState: View {
...
// MARK: - WorkspaceMacProviderConnectionPopup

struct WorkspaceMacProviderConnectionPopup: View {
    // MARK: Lifecycle
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            WorkspaceMacProviderConnectionNavigation(dismiss: dismiss, back: back)
                .padding(.top, popupTopPadding)
                .padding(.horizontal, popupHorizontalPadding)
                .padding(.bottom, 10)
            ...
            ScrollView(.vertical, showsIndicators: true) {
                VStack(alignment: .leading, spacing: bodySpacing) {
                    ...
                    WorkspaceMacProviderConnectionMethodPicker(
            ...
            WorkspaceMacProviderConnectionFooter(
        ...
        case .apiKey:
            VStack(alignment: .leading, spacing: 9) {
                ...
                SecureField("API key", text: $apiKey)
                    ...
                    .overlay(
                        RoundedRectangle(cornerRadius: 10, style: .continuous)
                            .stroke(WorkspaceMacProviderPickerPalette.stroke.opacity(0.82), lineWidth: 1)
                    )
...
// MARK: - WorkspaceMacProviderConnectionFooter

struct WorkspaceMacProviderConnectionFooter: View {
    let title: String
    let isDisabled: Bool
    let action: () -> Void
    ...
    var body: some View {
        Button(action: action) {
            Text(title)
                .font(.system(size: 17, weight: .semibold))
                .foregroundStyle(WorkspaceMacProviderPickerPalette.primaryButtonText)
                .frame(maxWidth: .infinity)
                .frame(height: buttonHeight)
                .background(
                    RoundedRectangle(cornerRadius: 12, style: .continuous)
                        .fill(WorkspaceMacProviderPickerPalette.primaryButtonBackground)
                )
                .overlay(
                    RoundedRectangle(cornerRadius: 12, style: .continuous)
                        .stroke(WorkspaceMacProviderPickerPalette.primaryButtonStroke, lineWidth: 1)
                )
        }
        .buttonStyle(.plain)
        .disabled(isDisabled)
        ...
        .padding(.bottom, 16)
        .background(
            WorkspaceMacProviderPickerPalette.background
                .overlay(alignment: .top) {
                    Rectangle()
                        .fill(WorkspaceMacProviderPickerPalette.stroke.opacity(0.62))
                        .frame(height: 1)
                }
        )
    }
...
// MARK: - WorkspaceMacProviderConnectionNavigation

struct WorkspaceMacProviderConnectionNavigation: View {
    let dismiss: () -> Void
    let back: () -> Void
...
// MARK: - WorkspaceMacProviderConnectionMethodPicker

struct WorkspaceMacProviderConnectionMethodPicker: View {
        ...
        VStack(alignment: .leading, spacing: 10) {
            ...
            VStack(spacing: 8) {
                ForEach(methods) { method in
                    WorkspaceMacProviderConnectionMethodRow(
                        method: method,
...
// MARK: - WorkspaceMacProviderConnectionMethodRow

struct WorkspaceMacProviderConnectionMethodRow: View {
    ...
    var body: some View {
        Button(action: select) {
            HStack(alignment: .top, spacing: 13) {
                ZStack {
                    Circle()
                        .stroke(
                            isSelected
                                ? WorkspaceMacProviderPickerPalette.primaryButtonBackground
                                : WorkspaceMacProviderPickerPalette.stroke,
                            lineWidth: 1.6
                        )
            ...
            .background(
                RoundedRectangle(cornerRadius: 12, style: .continuous)
                    .fill(isSelected ? WorkspaceMacProviderPickerPalette.selectedBackground : WorkspaceMacProviderPickerPalette.fieldBackground)
            )
            .overlay(
                RoundedRectangle(cornerRadius: 12, style: .continuous)
                    .stroke(
                        isSelected
                            ? WorkspaceMacProviderPickerPalette.selectedStroke
                            : WorkspaceMacProviderPickerPalette.stroke.opacity(0.74),
                        lineWidth: 1
                    )
            )
            .contentShape(RoundedRectangle(cornerRadius: 12, style: .continuous))
...
// MARK: - WorkspaceMacCenteredProviderPopupOverlay

struct WorkspaceMacCenteredProviderPopupOverlay<Content: View>: View {
    let dismiss: () -> Void
...
// MARK: - WorkspaceMacProviderPickerPalette

enum WorkspaceMacProviderPickerPalette {
...
#if DEBUG
    private struct WorkspaceMacProviderPickerPopupPreview: View {
    ...
    private struct WorkspaceMacProviderSearchFieldPreview: View {
        @State private var searchText = ""
    ...
    private struct WorkspaceMacProviderPickerRowsPreview: View {
        @State private var selectedProviderID = WorkspacePreviewSupport.defaultProviders.first?.id
    ...
    private struct WorkspaceMacProviderConnectionPopupPreview: View {
        var body: some View {
    ...
    private struct WorkspaceMacProviderConnectionMethodPickerPreview: View {
    ...
    #Preview("Provider Picker Popup Component") {
        WorkspaceMacProviderPickerPopupPreview()
    }

    #Preview("Provider Picker Header Component") {
        WorkspaceMacProviderPickerHeader(dismiss: { })
            .frame(width: 500)
            .workspaceComponentPreviewSurface()
    }

    #Preview("Provider Search Field Component") {
        WorkspaceMacProviderSearchFieldPreview()
    }

    #Preview("Provider Picker Rows Component") {
        WorkspaceMacProviderPickerRowsPreview()
    }

    #Preview("Provider Empty State Component") {
        WorkspaceMacProviderEmptyState(searchText: "OpenRouter")
            .frame(width: 500)
            .workspaceComponentPreviewSurface()
    }

    #Preview("Provider Connection Popup Component") {
        WorkspaceMacProviderConnectionPopupPreview()
    }

    #Preview("Provider Connection Navigation Component") {
        WorkspaceMacProviderConnectionNavigation(dismiss: { }, back: { })
            .frame(width: 500)
            .workspaceComponentPreviewSurface()
    }

    #Preview("Provider Connection Method Component") {
        WorkspaceMacProviderConnectionMethodPickerPreview()
    }
