//
//  WorkspaceIOSQuickPromptSectionView.swift
//  OpenSpace
//
...
// MARK: - WorkspaceIOSQuickPromptSection

struct WorkspaceIOSQuickPromptSection: View {
    // MARK: Internal
...
#Preview("iPhone Workspace Quick Prompts") {
