...
private struct WorkspaceIOSUtilityBar: View {
  ...
  var body: some View {
    HStack(spacing: context.contentTopBarSpacing) {
      ...
      WorkspaceIOSBarIconButton(systemImage: "magnifyingglass", accessibilityLabel: "Search thread")
...
private struct WorkspaceIOSBarIconButton: View {
  @Environment(\.colorScheme) private var colorScheme
...
private struct WorkspaceIOSHeroHeading: View {
  let context: WorkspaceRenderContext
  ...
  var body: some View {
    VStack(alignment: .leading, spacing: 16) {
      ...
      HStack(alignment: .center, spacing: 12) {
        HStack(spacing: 10) {
          WorkspaceIOSSurfaceChip(title: "Attach", systemImage: "paperclip")
...
private struct WorkspaceIOSQuickPromptSection: View {
  @Environment(\.colorScheme) private var colorScheme
  let context: WorkspaceRenderContext
